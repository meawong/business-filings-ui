...
import { BusinessConfigBc } from '@/resources/BC'
...
describe('Standalone Office Address Filing - Part 1 - UI', () => {
  ...
  it('Verify COA Certify contains correct section codes', async () => {
    ...
    expect(certify.vm.message).toContain('See Section 27 of the Cooperative Association Act.')
...
describe('Standalone Office Address Filing - Part 2D - Resuming (BCOMP)', () => {
  ...
  beforeEach(() => {
    ...
    // mock "fetch a draft filing" endpoint
    sinon.stub(axios, 'get').withArgs('https://business-api.url/v2/businesses/BC0007291/filings/123')
      .returns(new Promise(resolve => resolve({
        data: {
          filing: {
            changeOfAddress: {
...
describe('Standalone Office Address Filing - Part 3 - Submitting', () => {
  ...
  beforeEach(() => {
    ...
    // mock "fetch a draft filing" endpoint
    sinonAxiosGet.withArgs('https://business-api.url/v2/businesses/CP0001191/filings/123')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
    ...
    sinonAxiosGet.withArgs('https://business-api.url/v2/businesses/CP0001191/tasks')
      .returns(new Promise(resolve => resolve({
        data: {
          'tasks': [
            {
...
describe('Standalone Office Address Filing - Part 3B - Submitting (BCOMP)', () => {
  ...
  beforeEach(() => {
    ...
    // mock "fetch a draft filing" endpoint
    sinonAxiosGet.withArgs('https://business-api.url/v2/businesses/BC0007291/filings/123')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
    ...
    sinonAxiosGet.withArgs('https://business-api.url/v2/businesses/BC0007291/tasks')
      .returns(new Promise(resolve => resolve({
        data: {
          'tasks': [
            {
    ...
    // mock "save and file" endpoint
    sinon.stub(axios, 'post').withArgs('https://business-api.url/v2/businesses/BC0007291/filings')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
    ...
    // mock "update and file" endpoint
    sinon.stub(axios, 'put').withArgs('https://business-api.url/v2/businesses/BC0007291/filings/123')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
...
describe('Standalone Office Address Filing - Part 4B - Saving (BCOMP)', () => {
  ...
  beforeEach(() => {
    ...
    // mock "save draft" endpoint
    sinon.stub(axios, 'post').withArgs('https://business-api.url/v2/businesses/BC0007291/filings?draft=true')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
    ...
    sinon.stub(axios, 'get').withArgs('https://business-api.url/v2/businesses/BC0007291/tasks')
      .returns(new Promise(resolve => resolve({
        data: {
          'tasks': [
            {
...
describe('Standalone Office Address Filing - Part 5 - Data (BCOMP)', () => {
  ...
  beforeEach(() => {
    ...
    // mock "save draft" endpoint
    spy = sinon.stub(axios, 'post').withArgs('https://business-api.url/v2/businesses/BC0007291/filings?draft=true')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
  ...
  it('Verify COA Certify contains correct section codes', async () => {
    ...
    rootStore.configObject = BusinessConfigBc
    await Vue.nextTick()

    const certify: any = wrapper.findComponent(Certify)
    expect(certify.exists()).toBe(true)
    expect(certify.vm.message).toContain('See section 427 of the <em>Business Corporations Act</em>')
    expect(certify.vm.entityDisplay).toEqual('BC Limited Company')
...
describe('Standalone Office Address Filing - Part 6 - Error/Warning Dialogs', () => {
  ...
  beforeEach(() => {
    ...
    // mock "fetch a draft filing" endpoint
    sinonAxiosGet
      .withArgs('https://business-api.url/v2/businesses/CP0001191/filings/123')
      .returns(new Promise(resolve => resolve({
        data:
        {
          'filing': {
